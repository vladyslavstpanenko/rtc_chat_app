...
function handleButtonClick() {
  ...
  document.getElementById("roomid").value = randomString;
}
    ...
    volumes.forEach((volume) => {
      ...
      try {
        ...
        if (volume.level >= 50) {
          ...
          item.style.boxShadow = `0px 0px 20px #00ff00`; // Add shadow with the same border color
        } else {
